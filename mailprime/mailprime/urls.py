...
urlpatterns = patterns('',
    ...
    url(r'^tos$', views.terms_of_service, name='terms_of_service'),
    url(r'^(\w+)/account$', views.user_account, name='user_account'),
    url(r'^(\w+)/campaigns$', views.user_campaigns, name='user_campaigns'),
    url(r'^(\w+)/campaigns/new$', views.user_campaign_new, name='user_campaign_new'),
    ...
    url(r'^(\w+)/campaign-(\d+)/messages/new$', views.user_campaign_message_new, name='user_campaign_message_new'),
